...
const Hero = () => {
  return (
    <main className="min-h-screen bg-hero-bg bg-cover md:bg-center bg-left-top bg-no-repeat relative z-40">
      <div className="flex flex-col items-center justify-between md:px-24 md:pt-40 py-20 px-3">
        <div className="md:w-[55%] w-[86%]">
          ...
          <div className="md:flex items-center content-center justify-center pt-8 hidden">
      ...
      <div className="text-white text-[15px] font-[400] flex md:gap-8 gap-3 justify-end md:pr-20 pr-6">
        <a href="/">Facebook</a>
        <a href="/">Instagram</a>
        <a href="/">Twitter</a>
      </div>
      <div className="absolute min-h-screen w-full bg-[#000] top-0 left-0 opacity-[0.2] -z-10"></div>
    </main>
  );
};
